...
let ingredients = [
  {
    qty: 350,
    unit: "g",
    name: "gekochter kalter Reis",
    note: "(am besten vom Vortag, Jasminreis)",
  },
  { qty: 2, unit: "Stk", name: "Ei(er)" },
  {
    qty: 150,
    unit: "g",
    name: "Hähnchenfleisch oder Garnelen",
    note: "(optional)",
  },
  ...
  { qty: 2, unit: "Stk", name: "Knoblauchzeh(en)" },
  {
    qty: 1,
    unit: "Stk",
    name: "kleine Rote Chili",
    note: "(nach Schärfewunsch, optional Chiliflocken)",
  },
  {
    qty: 0.5,
    unit: "TL",
    name: "Terasi",
    note: "(Indonesische Shrimppaste, optional)",
  },
  { qty: 0.25, unit: "TL", name: "Salz" },
  {
    ...
    unit: "EL",
    name: "Kecap Manis",
    note: "(süße indonesische Sojasoße)",
  },
